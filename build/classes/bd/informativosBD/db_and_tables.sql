...
CREATE TABLE IF NOT EXISTS `mydb`.`funcionarios` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `num_id_UNIQUE` (`num_id` ASC) ,
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) ,
  INDEX `fk_funcionarios_tipos_documentos_idx` (`tipos_documentos_id` ASC) ,
  INDEX `fk_funcionarios_estados_civiles1_idx` (`estados_civiles_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`familiares_funcionarios` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_familiares_funcionarios_funcionarios1_idx` (`funcionarios_id` ASC),
  INDEX `fk_familiares_funcionarios_parentezcos1_idx` (`parentezcos_id` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`formaciones_academicas` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_formaciones_academicas_funcionarios1_idx` (`funcionarios_id` ASC),
  INDEX `fk_formaciones_academicas_universidades1_idx` (`universidades_id` ASC) ,
  INDEX `fk_formaciones_academicas_niveles_educativos1_idx` (`niveles_educativos_id` ASC) ,
